...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->txtSource->Size = System::Drawing::Size(494, 20);
			...
			this->txtDestination->Size = System::Drawing::Size(497, 20);
			...
			this->btnNavSource->Location = System::Drawing::Point(515, 23);
			...
			this->btnNavDestination->Location = System::Drawing::Point(515, 62);
			...
			this->btnCopy->Size = System::Drawing::Size(532, 23);
			...
			this->txtLog->Anchor = static_cast<System::Windows::Forms::AnchorStyles>((((System::Windows::Forms::AnchorStyles::Top | System::Windows::Forms::AnchorStyles::Bottom)
				...
				| System::Windows::Forms::AnchorStyles::Right));
			this->txtLog->Location = System::Drawing::Point(81, 270);
			this->txtLog->Name = L"txtLog";
			this->txtLog->ReadOnly = true;
			this->txtLog->Size = System::Drawing::Size(460, 20);
			...
			this->label1->Location = System::Drawing::Point(12, 341);
			...
			this->lblBuffer->Location = System::Drawing::Point(118, 341);
			this->lblBuffer->Name = L"lblBuffer";
			this->lblBuffer->Size = System::Drawing::Size(38, 13);
			this->lblBuffer->TabIndex = 9;
			...
			this->txtBuffer->Location = System::Drawing::Point(121, 357);
			...
			this->txtCurSrc->Size = System::Drawing::Size(532, 20);
			this->txtCurSrc->TabIndex = 3;
			// 
			// label3
			// 
			...
			this->txtCurDst->Size = System::Drawing::Size(532, 20);
			this->txtCurDst->TabIndex = 4;
			// 
			// label4
			// 
			...
			// txtTotalSize
			// 
			this->txtTotalSize->Location = System::Drawing::Point(81, 221);
			this->txtTotalSize->Name = L"txtTotalSize";
			this->txtTotalSize->ReadOnly = true;
			this->txtTotalSize->Size = System::Drawing::Size(174, 20);
			this->txtTotalSize->TabIndex = 14;
			// 
			// label7
			// 
			this->label7->AutoSize = true;
			this->label7->Location = System::Drawing::Point(261, 224);
			...
			// txtTotalProcessed
			// 
			this->txtTotalProcessed->Location = System::Drawing::Point(373, 221);
			this->txtTotalProcessed->Name = L"txtTotalProcessed";
			this->txtTotalProcessed->ReadOnly = true;
			this->txtTotalProcessed->Size = System::Drawing::Size(167, 20);
			this->txtTotalProcessed->TabIndex = 14;
			// 
			// label8
			// 
			this->label8->AutoSize = true;
			this->label8->Location = System::Drawing::Point(14, 250);
			...
			this->label9->Location = System::Drawing::Point(261, 250);
			...
			// txtCurrentSize
			// 
			this->txtCurrentSize->Location = System::Drawing::Point(81, 247);
			this->txtCurrentSize->Name = L"txtCurrentSize";
			this->txtCurrentSize->ReadOnly = true;
			this->txtCurrentSize->Size = System::Drawing::Size(174, 20);
			this->txtCurrentSize->TabIndex = 14;
			// 
			// txtCurrentProcessed
			// 
			this->txtCurrentProcessed->Location = System::Drawing::Point(373, 247);
			this->txtCurrentProcessed->Name = L"txtCurrentProcessed";
			this->txtCurrentProcessed->ReadOnly = true;
			this->txtCurrentProcessed->Size = System::Drawing::Size(167, 20);
			this->txtCurrentProcessed->TabIndex = 14;
			// 
			// label10
			// 
			this->label10->AutoSize = true;
			this->label10->Location = System::Drawing::Point(14, 200);
			...
			this->label11->Location = System::Drawing::Point(261, 200);
			...
			// txtTotalCount
			// 
			this->txtTotalCount->Location = System::Drawing::Point(81, 197);
			this->txtTotalCount->Name = L"txtTotalCount";
			this->txtTotalCount->ReadOnly = true;
			this->txtTotalCount->Size = System::Drawing::Size(174, 20);
			this->txtTotalCount->TabIndex = 14;
			// 
			// txtProcessedCount
			// 
			this->txtProcessedCount->Location = System::Drawing::Point(373, 197);
			this->txtProcessedCount->Name = L"txtProcessedCount";
			this->txtProcessedCount->ReadOnly = true;
			this->txtProcessedCount->Size = System::Drawing::Size(167, 20);
			this->txtProcessedCount->TabIndex = 14;
			// 
			// timerUpdate
			// 
			...
			this->label12->Location = System::Drawing::Point(12, 273);
			...
			this->btnShowLog->Location = System::Drawing::Point(439, 355);
			this->btnShowLog->Name = L"btnShowLog";
			this->btnShowLog->Size = System::Drawing::Size(75, 23);
			...
			this->btnSuspend->Location = System::Drawing::Point(12, 306);
			this->btnSuspend->Name = L"btnSuspend";
			this->btnSuspend->Size = System::Drawing::Size(529, 23);
			...
			this->ClientSize = System::Drawing::Size(556, 389);
			this->Controls->Add(this->btnSuspend);
			this->Controls->Add(this->btnShowLog);
			this->Controls->Add(this->txtCurrentProcessed);
...
#pragma endregion
	...
	private:
		...
		System::Void btnShowLog_Click(System::Object^ sender, System::EventArgs^ e) {
			logForm_->Visible = !logForm_->Visible;
		}
